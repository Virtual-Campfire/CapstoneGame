...
public class FieldOfViewFollow : MonoBehaviour
{
    [Header("View Setting")]
    ...
    // Nav mesh agent used for calling pathfinding functions
    NavMeshAgent agent;
    ...
    ViewCastInfo ViewCast(float globalAngle)
    {
        ...
        if (Physics.Raycast(transform.position, dir, out hit, viewRadius, targetMask))
        {
            ...
            // Move nav mesh agent to player location
